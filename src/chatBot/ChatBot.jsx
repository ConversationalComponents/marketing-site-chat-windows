...
import FinishFailed from "./components/FinishFailed";
  ...
  render() {
    ...
    return (
      <ChatBotContainer width={width} height={height}>
        ...
        <Footer>
          {finishFailed && (
            <FinishFailed onClick={resetSession}>
              <ComponentStatus>Component Failed!</ComponentStatus>
              <Reset>RESET</Reset>
            </FinishFailed>
          )}
          {finishSuccess && (
            <FinishSuccess onClick={resetSession}>
              <ComponentStatus>Goal Achieved Successfully!</ComponentStatus>
              <Reset>RESET</Reset>
            </FinishSuccess>
          )}
